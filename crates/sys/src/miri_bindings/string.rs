...
pub unsafe fn furi_string_alloc() -> *mut FuriString {
    Box::into_raw(Box::new(FuriString {
        inner: String::new(),
        c: None,
    }))
}
...
pub unsafe fn furi_string_alloc_set_str(cstr_source: *const c_char) -> *mut FuriString {
    let mut inner = String::new();
    let cstr_source = unsafe { CStr::from_ptr(cstr_source) };
    inner.push_str(
        cstr_source
            .to_str()
            .expect("Must provide a valid UTF-8 string"),
    );

    Box::into_raw(Box::new(FuriString { inner, c: None }))
}
...
pub unsafe fn furi_string_reserve(string: *mut FuriString, size: usize) {
    let inner = &mut unsafe { &mut *string }.inner;
    inner.reserve(size);
}
...
pub unsafe fn furi_string_get_char(string: *const FuriString, index: usize) -> c_char {
    todo!()
}
#[doc = "Return the string view a classic C string.\n\n # Arguments\n\n* `string` - The FuriString instance\n\n # Returns\n\nconst C-string, usable till first container change"]
pub unsafe fn furi_string_get_cstr(string: *const FuriString) -> *const c_char {
    let inner = unsafe { &mut *(string.cast_mut()) };
    let cstr = Rc::new(CString::new(inner.inner.as_bytes()).unwrap());
    inner.c = Some(cstr.clone());
    cstr.as_ptr()
}
...
pub unsafe fn furi_string_set_str(string: *mut FuriString, source: *const c_char) {
    todo!()
}
#[doc = "Set the string to the n first characters of the C string.\n\n # Arguments\n\n* `string` - The FuriString instance\n * `source` - The source\n * `length` - The length"]
pub unsafe fn furi_string_set_strn(string: *mut FuriString, source: *const c_char, length: usize) {
    todo!()
}
#[doc = "Set the character at the given index.\n\n # Arguments\n\n* `string` - The FuriString instance\n * `index` - The index\n * `c` - The character"]
pub unsafe fn furi_string_set_char(string: *mut FuriString, index: usize, c: c_char) {
    todo!()
}
...
pub unsafe fn furi_string_push_back(string: *mut FuriString, c: c_char) {
    let inner = &mut unsafe { &mut *string }.inner;
    inner.push(char::from(c));
}
...
pub unsafe fn furi_string_equal_str(string_1: *const FuriString, cstring_2: *const c_char) -> bool {
    todo!()
}
...
pub unsafe fn furi_string_cat_str(string_1: *mut FuriString, cstring_2: *const c_char) {
    todo!()
}
...
pub unsafe fn furi_string_start_with_str(string: *const FuriString, start: *const c_char) -> bool {
    todo!()
}
...
pub unsafe fn furi_string_end_with_str(string: *const FuriString, end: *const c_char) -> bool {
    todo!()
}
#[doc = "Search the first occurrence of the needle in the string from the position\n start.\n\n # Arguments\n\n* `string` - The FuriString instance\n * `needle` - The needle\n * `start` - The start (By default, start is zero)\n\n # Returns\n\nposition or FURI_STRING_FAILURE if not found"]
...
pub unsafe fn furi_string_search_char(string: *const FuriString, c: c_char, start: usize) -> usize {
    todo!()
}
#[doc = "Search for the position of the character c from the position start (include)\n in the string.\n\n # Arguments\n\n* `string` - The FuriString instance\n * `c` - The character\n * `start` - The start (By default, start is zero)\n\n # Returns\n\nposition or FURI_STRING_FAILURE if not found"]
